...
data_dict = pickle.load(open("../13  Validation/final_project_dataset.pkl", "r"))
...
'''
[Q1] How many POIs are predicted for the test set for your POI identifier?
[A1] 4.0
[Q2] How many people total are in your test set?
[A2] 29
[Q3] If your identifier predicted 0. (not POI) for everyone in the test set, what would its accuracy be?
[A3] 0.862068965517
[Q4] Do you get any true positives? (In this case, we define a true positive as a case where both the actual label and the predicted label are 1)
[A3] 0
Precision score: 0.0
Recall score: 0.0
'''